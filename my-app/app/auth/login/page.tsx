  ...
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4 selection:bg-cyan-500/30">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
        <div className="absolute top-[-5%] right-[-5%] w-[35%] h-[35%] bg-cyan-600/10 blur-[100px] rounded-full" />
        <div className="absolute bottom-[-5%] left-[-5%] w-[35%] h-[35%] bg-blue-600/10 blur-[100px] rounded-full" />
      </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="text-center pt-4">
                <p className="text-slate-500 text-xs">
                  New to the gallery? <Link href="/auth/signup" className="text-white font-bold hover:text-cyan-400 transition-colors">Create Account</Link>
                </p>
              </div>
            </form>
          </div>
